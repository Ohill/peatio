...
module APIv2
  class Fees < Grape::API
    ...
    desc 'Returns withdraw fees for currencies.', deprecated: true
    ...
    desc 'Returns deposit fees for currencies.', deprecated: true
    get '/fees/deposit' do
    ...
    desc 'Returns trading fees for markets.', deprecated: true
    get '/fees/trading' do
