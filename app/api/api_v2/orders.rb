...
module APIv2
  class Orders < Grape::API
    ...
    desc 'Get information of specified order.', scopes: %w[history trade], success: APIv2::Entities::Order
    params do
      use :order_id
    end
    get '/order' do
    ...
    desc 'Create multiple sell/buy orders.', scopes: %w[trade], success: APIv2::Entities::Order
    params do
      use :market
    ...
    desc 'Create a Sell/Buy order.', scopes: %w[trade], success: APIv2::Entities::Order
    params do
      use :market, :order
    end
    post '/orders' do
    ...
    desc 'Cancel an order.', scopes: %w[trade], success: APIv2::Entities::Order
    params do
      use :order_id
    end
    post '/order/delete' do
      ...
      raise CancelOrderError, $ERROR_INFO
    end

    desc 'Cancel all my orders.', scopes: %w[trade], success: APIv2::Entities::Order
    params do
